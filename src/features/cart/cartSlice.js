...
const cartSlice = createSlice({
    ...
    reducers : {
        ...
        decreaseItemQuantity(state,action){
            ...
            //in the if below we can copy the deleteItem above or use this built in trick below, I meant to copy this : state.cart = state.cart.filter(item => item.pizzaId !== action.payload)
